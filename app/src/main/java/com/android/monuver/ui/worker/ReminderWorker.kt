package com.android.monuver.ui.worker
...
import com.android.monuver.ui.feature.screen.MainActivity
...
class ReminderWorker(
    ...
    override suspend fun doWork(): Result {
        ...
        bills.forEach { bill ->
            val dueDate = LocalDate.parse(bill.dueDate, DateTimeFormatter.ISO_DATE)
...
fun startReminderWorker(context: Context) {
