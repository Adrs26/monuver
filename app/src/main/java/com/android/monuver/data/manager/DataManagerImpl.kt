package com.android.monuver.data.manager
...
import com.android.monuver.data.local.entity.projection.BackupData
import com.android.monuver.data.mapper.toDomain
import com.android.monuver.data.mapper.toEntityProjection
...
import com.android.monuver.domain.usecase.finance.BackupData as BackupDataDomain
...
class DataManagerImpl(
    ...
    override suspend fun backupData(data: BackupDataDomain) {
    ...
    override suspend fun restoreData(stringUri: String): BackupDataDomain {
        val backupDataJson = withContext(coroutineDispatchers.io) {
