...
class GetTransactionMonthlyAmountSummaryUseCase(
    private val repository: TransactionRepository
) {
    operator fun invoke(month: Int, year: Int): Flow<TransactionMonthlyAmountSummary> {
        ...
        return combine(
            ...
            TransactionMonthlyAmountSummary(
