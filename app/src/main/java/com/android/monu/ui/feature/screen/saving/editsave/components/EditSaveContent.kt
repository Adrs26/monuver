package com.android.monu.ui.feature.screen.saving.editsave.components
...
fun EditSaveContent(
    ...
    Column(
        ...
        StaticTextInputField(
            ...
            value = NumberFormatHelper.formatToRupiah(saveState.currentAmount),
        ...
        Button(
            onClick = { saveActions.onEditSave(saveState) },
            modifier = Modifier
                .fillMaxWidth()
                .padding(24.dp),
        ) {
...
data class EditSaveContentState(
    val id: Long,
    val title: String,
...
interface EditSaveContentActions {
    fun onTitleChange(title: String)
    fun onDateClick()
    fun onTargetAmountChange(targetAmountFormat: TextFieldValue)
    fun onEditSave(saveState: EditSaveContentState)
}