...
import com.android.monu.presentation.screen.transaction.components.TransactionFilterState
import com.android.monu.presentation.screen.transaction.components.TransactionList
import com.android.monu.presentation.screen.transaction.components.TransactionTopBar
...
fun TransactionScreen(
    ...
    Column(
        ...
        TransactionTopBar(
            ...
            onQueryChange = { transactionActions.onQueryChange(it) },
    ...
    if (showFilterDialog) {
        TransactionFilterDialog(
            ...
            onFilterApply = { type, year, month ->
                transactionActions.onFilterApply(type, year, month)
            }
        )
    }
}
