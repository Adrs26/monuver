package com.android.monuver.feature.account.presentation.accountDetail.components
...
internal fun AccountDetailContent(
    ...
    Column(
        ...
        AccountDetailData(
            ...
            content = accountState.balance.toRupiah()
        )
        HorizontalDivider(color = MaterialTheme.colorScheme.surfaceVariant)
        AccountDetailData(
            title = stringResource(R.string.status),
            content = if (accountState.isActive) stringResource(R.string.active) else
