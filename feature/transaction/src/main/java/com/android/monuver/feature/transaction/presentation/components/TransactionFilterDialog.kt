...
private fun TransactionFilterMenu(
    ...
    val yearFilterOptions = listOf(0) + filterDialogState.yearFilterOptions
    val monthFilterOptions = DataProvider.provideMonthFilterOptions()

    var tempTypeFilter by remember { mutableStateOf(filterDialogState.typeFilter) }
    var tempYearFilter by remember { mutableStateOf(filterDialogState.yearFilter) }
    var tempMonthFilter by remember { mutableStateOf(filterDialogState.monthFilter) }
